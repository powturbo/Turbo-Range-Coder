...
ALIGNED(static const unsigned char, mtf_shuffle_matrix[16][16],16) = {
    ...
    /* L =  3 (k = 35) */ { 0x01, 0x02, 0x03, 0x80, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F },
    /* L =  4 (k = 36) */ { 0x01, 0x02, 0x03, 0x04, 0x80, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F },
    /* L =  5 (k = 37) */ { 0x01, 0x02, 0x03, 0x04, 0x05, 0x80, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F },
    /* L =  6 (k = 38) */ { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x80, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F },
    /* L =  7 (k = 39) */ { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x80, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F },
    /* L =  8 (k = 40) */ { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x80, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F },
    /* L =  9 (k = 41) */ { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x80, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F },
    /* L = 10 (k = 42) */ { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x80, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F },
    /* L = 11 (k = 43) */ { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x80, 0x0C, 0x0D, 0x0E, 0x0F },
    /* L = 12 (k = 44) */ { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x80, 0x0D, 0x0E, 0x0F },
    /* L = 13 (k = 45) */ { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x80, 0x0E, 0x0F },
    /* L = 14 (k = 46) */ { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x80, 0x0F },
...
#define EMA( _n_,_x_,_a_,_y_) (((int64_t)(_x_) * (_a_) + ((1ll << (_n_)) - (_a_)) * (_y_) + (1ll << ((_n_) - 1))) >> (_n_)) //2 <= N <= 30
